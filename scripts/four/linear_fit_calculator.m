...
[linearModel.fit.N1(1,:)]=dynamic.name;
...
[linearModel.fit.N2(1,:)]=dynamic.name;
clearvars x y xn yn md k startFrame endFrame
...
[linearModel.fit.P1(1,:)]=dynamic.name;
...
[linearModel.fit.P2(1,:)]=dynamic.name;
clearvars x y xn yn md k startFrame endFrame
...
[linearModel.fit.P3(1,:)]=dynamic.name;
...
[linearModel.fit.P4(1,:)]=dynamic.name;
