...
%   N1 (Cumming 1993) 
%%%%%%%%%%%%%%%%%%%%%%%
FrameWidth=ceil(FrameLength/TAC_interpol.stepLength);

FitColumn=iterative_region_idx;
x= dynamic.vol(2:end,FitColumn);
y=dynamic.kappa(2:end,FitColumn);
...
[maxVal, BestFit.N1.firstInd] = max(BestFit.N1.rsq);
BestFit.N1.lastInd = BestFit.N1.firstInd + FrameWidth - 1

BestFit.N1.time_BestFit = TAC_interpol.time_min(BestFit.N1.firstInd:BestFit.N1.lastInd,1);

clearvars   md xn yn k firstInd lastInd maxVal x y; 

%%%%%%%%%%%%%%%%%%%%%%%
%   N2 (Gjedde 2000)
%%%%%%%%%%%%%%%%%%%%%%%

x= dynamic.kappa(2:end,FitColumn);
y=dynamic.vol(2:end,FitColumn);
...
[maxVal, BestFit.N2.firstInd] = max(BestFit.N2.rsq);
BestFit.N2.lastInd = BestFit.N2.firstInd + FrameWidth - 1

BestFit.N2.time_BestFit = TAC_interpol.time_min(BestFit.N2.firstInd:BestFit.N2.lastInd,1);
...
x= dynamic.theta(2:end,FitColumn);
y=dynamic.kappa_reciproc(2:end,FitColumn);
...
[maxVal,BestFit.P1.firstInd] = max(BestFit.P1.rsq);
BestFit.P1.lastInd =BestFit.P1.firstInd + FrameWidth - 1

BestFit.P1.time_BestFit = TAC_interpol.time_min(BestFit.P1.firstInd:BestFit.P1.lastInd,1);
...
x= dynamic.kappa_reciproc(2:end,FitColumn);
y=dynamic.theta(2:end,FitColumn);
...
[maxVal, BestFit.P2.firstInd] = max(BestFit.P2.rsq);
BestFit.P2.lastInd = BestFit.P2.firstInd + FrameWidth - 1

BestFit.P2.time_BestFit = TAC_interpol.time_min(BestFit.P2.firstInd:BestFit.P2.lastInd,1);
...
x= dynamic.vol_reciproc(2:end,FitColumn);
y=dynamic.theta_reciproc(2:end,FitColumn);
...
[maxVal, BestFit.P3.firstInd] = max(BestFit.P3.rsq);
BestFit.P3.lastInd = BestFit.P3.firstInd + FrameWidth - 1

BestFit.P3.time_BestFit = TAC_interpol.time_min(BestFit.P3.firstInd:BestFit.P3.lastInd,1);
...
x= dynamic.theta_reciproc(2:end,FitColumn);
y=dynamic.vol_reciproc(2:end,FitColumn);
...
[maxVal, BestFit.P4.firstInd] = max(BestFit.P4.rsq);
BestFit.P4.lastInd = BestFit.P4.firstInd + FrameWidth - 1

BestFit.P4.time_BestFit = TAC_interpol.time_min(BestFit.P4.firstInd:BestFit.P4.lastInd,1);

clearvars  md xn yn k firstInd lastInd maxVal x y FitColumn; 
...
BestFit.all_plots(1,3)=TAC_interpol.time_min(BestFit.N1.firstInd,1);
BestFit.all_plots(1,4)=TAC_interpol.time_min(BestFit.N1.lastInd,1);

BestFit.all_plots(2,1)=BestFit.N2.firstInd;
BestFit.all_plots(2,2)=BestFit.N2.lastInd;
BestFit.all_plots(2,3)=TAC_interpol.time_min(BestFit.N2.firstInd,1);
BestFit.all_plots(2,4)=TAC_interpol.time_min(BestFit.N2.lastInd,1);

BestFit.all_plots(3,1)=BestFit.P1.firstInd;
BestFit.all_plots(3,2)=BestFit.P1.lastInd;
BestFit.all_plots(3,3)=TAC_interpol.time_min(BestFit.P1.firstInd,1);
BestFit.all_plots(3,4)=TAC_interpol.time_min(BestFit.P1.lastInd,1);

BestFit.all_plots(4,1)=BestFit.P2.firstInd;
BestFit.all_plots(4,2)=BestFit.P2.lastInd;
BestFit.all_plots(4,3)=TAC_interpol.time_min(BestFit.P2.firstInd,1);
BestFit.all_plots(4,4)=TAC_interpol.time_min(BestFit.P2.lastInd,1);

BestFit.all_plots(5,1)=BestFit.P3.firstInd;
BestFit.all_plots(5,2)=BestFit.P3.lastInd;
BestFit.all_plots(5,3)=TAC_interpol.time_min(BestFit.P3.firstInd,1);
BestFit.all_plots(5,4)=TAC_interpol.time_min(BestFit.P3.lastInd,1);

BestFit.all_plots(6,1)=BestFit.P4.firstInd;
BestFit.all_plots(6,2)=BestFit.P4.lastInd;
BestFit.all_plots(6,3)=TAC_interpol.time_min(BestFit.P4.firstInd,1);
BestFit.all_plots(6,4)=TAC_interpol.time_min(BestFit.P4.lastInd,1);

clearvars stepLength FrameLength 
